...
class IPsecSiteConnectionInvalid(qexception.BadRequest):
    message = _("ipsec_site_connection %(ipsec_site_connection)s is invalid")
...
class DescriptionInvalid(qexception.BadRequest):
    message = _("Description %(description)s is invalid, please set it as a JSON format")

class SubnetMustBeSet(qexception.BadRequest):
    message = _("One or more local subnets must be set.")

class TenantRouterIdMustBeSet(qexception.BadRequest):
    message = _("The tenant router id must be set in description")
