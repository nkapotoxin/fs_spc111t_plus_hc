...
VIF_TYPE_EVS = 'evs'
VIF_TYPES = [VIF_TYPE_UNBOUND, VIF_TYPE_BINDING_FAILED, VIF_TYPE_OVS,VIF_TYPE_EVS,
             VIF_TYPE_IVS, VIF_TYPE_BRIDGE, VIF_TYPE_802_QBG,
             VIF_TYPE_802_QBH, VIF_TYPE_HYPERV, VIF_TYPE_MIDONET,
             VIF_TYPE_MLNX_DIRECT, VIF_TYPE_MLNX_HOSTDEV, VIF_TYPE_HW_VEB,VIF_TYPE_VHOSTUSER,
...
VNIC_VHOSTUSER = 'vhostuser'
VNIC_SOFTDIRECT = 'softdirect'
VNIC_TYPES = [VNIC_NORMAL, VNIC_DIRECT, VNIC_MACVTAP, VNIC_VHOSTUSER, VNIC_SOFTDIRECT]
