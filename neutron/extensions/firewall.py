...
class FirewallRuleModeProfileNotMatch(qexception.Invalid):
    message = _("The input mode is profile but the rule_profile is None")

class FirewallRuleInvalid(qexception.InvalidInput):
    message = _("Rule body is invalid ")

class FirewallRuleDestinationIpNotPublicIp(qexception.InvalidInput):
    message = _("Destination ip address is not public ip ")

class FirewallRuleSourceIpNotPublicIp(qexception.InvalidInput):
    message = _("Source ip address is not public ip ")
...
fw_valid_mode_values = [constants.FWAAS_MODE_NORMAL, constants.FWAAS_MODE_MIX,
                        constants.FWAAS_MODE_PROFILE]
...
RESOURCE_ATTRIBUTE_MAP = {
    'firewall_rules': {
        ...
        'enabled': {'allow_post': True, 'allow_put': True,
                    ...
                    'is_visible': True},
        'mode': {'allow_post': True, 'allow_put': True,
                 'default': 'normal', 'convert_to': convert_action_to_case_insensitive,
                 'validate': {'type:values': fw_valid_mode_values},
                 'is_visible': True},
        'rule_profile': {'allow_post': True, 'allow_put': True,
                         'validate': {'type:string': None},
                         'is_visible': True, 'default': ''},
    },
    'firewall_policies': {
