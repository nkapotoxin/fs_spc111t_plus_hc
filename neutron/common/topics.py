...
SERVICECHAIN_AGENT = 'servicechain_agent'

LOADBALANCER_INTEGRATION = 'n-lbaas-int'
LOADBALANCER_INTEGRATION_PROXY = 'n-lbaas-int-proxy'

L3_HIGTPERFORMANCE_AGNET = 'l3_highperformance_agent'
L3_DATAENGINE = 'l3_dataengine'
