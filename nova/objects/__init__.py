...
def register_all():
    ...
    __import__('nova.objects.huawei_instance_extra')
    __import__('nova.objects.huawei_live_migration')
    __import__('nova.huawei.objects.affinity_group')
    __import__('nova.huawei.objects.volume_connection')
    __import__('nova.huawei.objects.ironic_volume')
