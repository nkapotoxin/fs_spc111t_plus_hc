...
def block_device_mapping_get_by_instance_and_volume_id(context, instance_uuid,
                                                       volume_id):
...
def huawei_instance_extra_get_by_instance_uuid(context, instance_uuid):
    """Get the Huawei instance extra record

    :param instance_uuid: = uuid of the instance tied to the topology record
    """
    return IMPL.huawei_instance_extra_get_by_instance_uuid(context, instance_uuid)


def injected_files_get_by_instance_uuid(context, instance_uuid):
    return IMPL.injected_files_get_by_instance_uuid(context, instance_uuid)


def huawei_instance_extra_get_by_host(context, host):
    """Get the Huawei instance extra records by host

    :param host: host's name
    """
    return IMPL.huawei_instance_extra_get_by_host(context, host)


def huawei_instance_extra_create(context, instance_uuid, updates):
    """Create the Huawei instance extra record

    :param instance_uuid: = uuid of the instance tied to the topology record
    """
    return IMPL.huawei_instance_extra_create(context, instance_uuid, updates)


def livemigrations_create(context, values):
    """Create a live-migrate record """
    return IMPL.livemigrations_create(context, values)


def livemigrations_get_all(context):
    """return all live-migrate list """
    return IMPL.livemigrations_get_all(context)


def livemigrations_get_all_by_host(context, host):
    """return all live-migrate by filter """
    return IMPL.livemigrations_get_all_by_host(context, host)


def livemigrations_get_by_uuid(context, uuid):
    """return record by instance uuid"""
    return IMPL.livemigrations_get_by_uuid(context, uuid)


def livemigrations_destroy(context, instance_id):
    """delete a live-migrate record using given instance_id"""
    return IMPL.livemigrations_destroy(context, instance_id)
