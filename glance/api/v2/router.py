...
from glance.huawei.api import images_copy
...
class API(wsgi.Router):
    ...
    def __init__(self, mapper):
        ...
        #for image copy
        images_copy_resource = images_copy.create_resource(custom_image_properties)
        mapper.connect('/images/action',
                       controller=images_copy_resource,
                       action='copy',
                       conditions={'method':['POST']})
