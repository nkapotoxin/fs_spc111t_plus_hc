...
class VMwareEsxVmdkDriver(driver.VolumeDriver):
    ...
    def session(self):
        if not self._session:
            ...
            try:
                ...
                LOG.debug(_("word has been decrypted "))
    ...
    def create_volume(self, volume):
        ...
        self._create_backing_in_inventory(volume)
    ...
    def _get_extra_spec_disk_type(type_id):
        ...
        disk_type = _get_volume_type_extra_spec(type_id,
                                                'vmdk_type',
                                                default_value=EAGER_ZEROED_THICK_VMDK_TYPE)
    ...
    def _initialize_connection(self, volume, connector):
        ...
        if volume.get('shareable', False) or volume.get('shareable') == "true":
            connection_info['shareable'] = True
        else:
            connection_info['shareable'] = False
    ...
    def _in_use(self, volume):
        ...
        return volume['volume_attachment'] is not None
