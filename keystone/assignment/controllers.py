...
class Tenant(controller.V2Controller):
    ...
    def get_all_projects(self, context, **kw):
        ...
        self.assert_admin(context, action="identity:list_projects")
    ...
    def get_project(self, context, tenant_id):
        ...
        self.assert_admin(context, action="identity:get_project")
    ...
    def create_project(self, context, tenant):
        ...
        self.assert_admin(context, action="identity:create_project")
    ...
    def update_project(self, context, tenant_id, tenant):
        self.assert_admin(context, action="identity:update_project")
    ...
    def delete_project(self, context, tenant_id):
        self.assert_admin(context, action="identity:delete_project")
...
class Role(controller.V2Controller):
    ...
    def get_user_roles(self, context, user_id, tenant_id=None):
        ...
        """
        self.assert_admin(context, action="identity:get_user_roles")
    ...
    def get_role(self, context, role_id):
        self.assert_admin(context, action="identity:get_role")
        return {'role': self.assignment_api.get_role(role_id)}

    @controller.v2_deprecated
    def create_role(self, context, role):
        role = self._normalize_dict(role)
        self.assert_admin(context, action="identity:create_role")
    ...
    def delete_role(self, context, role_id):
        self.assert_admin(context, action="identity:delete_role")
        self.assignment_api.delete_role(role_id)

    @controller.v2_deprecated
    def get_roles(self, context):
        self.assert_admin(context, action="identity:list_roles")
    ...
    def add_role_to_user(self, context, user_id, role_id, tenant_id=None):
        ...
        """
        self.assert_admin(context, action="identity:create_grant")
        if tenant_id is None:
            raise exception.NotImplemented(message='User roles not supported: '
                                                   'tenant_id required')
    ...
    def remove_role_from_user(self, context, user_id, role_id, tenant_id=None):
        ...
        """
        self.assert_admin(context, action="identity:delete_grant")
        if tenant_id is None:
            raise exception.NotImplemented(message='User roles not supported: '
                                                   'tenant_id required')
    ...
    def get_role_refs(self, context, user_id):
        ...
        """
        self.assert_admin(context, action="identity:get_role_refs")
    ...
    def create_role_ref(self, context, user_id, role):
        ...
        """
        self.assert_admin(context, action="identity:create_role_ref")
    ...
    def delete_role_ref(self, context, user_id, role_ref_id):
        ...
        """
        self.assert_admin(context, action="identity:delete_role_ref")
        # TODO(termie): for now we're ignoring the actual role
