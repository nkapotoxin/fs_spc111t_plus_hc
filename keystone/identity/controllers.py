...
class User(controller.V2Controller):
    ...
    def get_user(self, context, user_id):
        self.assert_admin(context, action="identity:get_user")
    ...
    def get_users(self, context):
        ...
        self.assert_admin(context, action="identity:list_users")
    ...
    def create_user(self, context, user):
        ...
        self.assert_admin(context, action="identity:create_user")
    ...
    def update_user(self, context, user_id, user):
        ...
        user = self.normalize_username_in_request(user)
        self.assert_admin(context, action="identity:update_user")
    ...
    def delete_user(self, context, user_id):
        self.assert_admin(context, action="identity:delete_user")
